...
class AlertUtil {
    ...
    static func displayUndertDevelopmentAlert() {
        infoAlert(title: NSLocalizedString("alert.title", comment: ""), message: NSLocalizedString("feature.under.development", comment: ""))
    }
    ...
    private static func displayAlert(title: String, message: String, style: NSAlert.Style) {
        ...
        alert.addButton(withTitle: NSLocalizedString("ok.button", comment: ""))
