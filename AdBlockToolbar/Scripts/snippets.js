/* This file is unaltered from the ABP original
 *  https://github.com/adblockplus/adblockpluscore/blob/next/lib/content/snippets.js
 * except for
 *  - the parsing of the 'environment' and
 *  - the removal of the FF-specific conditional block in injectCode
 */
...
function injectCode(code, dependencies = [])
{
  let executable = `
    ...
    {
      "use strict";
      let environment = JSON.stringify(${JSON.stringify({})});
...
function hideElement(element)
{
  ...
  let hide = () =>
  {
    for (let [key, value] of [["display", "none"]])
    {
